    ...
    return{
        ...
        deleteItem: function(type, id){
            ...
            ids = data.allItems[type].map(function(current){
                return current.id
            // returns array of ids, rather than of whole exp/inc objects    
            });
...
var UIController = (function(){
    ...
    return { 
        ...
        setDate: function(){
            ...
            var date, monthnum, month, months;
            ...
            document.querySelector(DOMstrings.dateSpace).textContent = month;
        ...
        displayBudget: function(obj){
            ...
            document.querySelector(DOMstrings.budgetLabel).textContent = formatNum(obj.budget);
            document.querySelector(DOMstrings.incomeLabel).textContent = formatNum(obj.totalInc);
            document.querySelector(DOMstrings.expensesLabel).textContent = formatNum(obj.totalExp);
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var updatePercentages = function(){
        ...
        //2 - get %s from budget controller
